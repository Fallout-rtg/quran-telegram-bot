...
SURAH_DATA = {
    ...
    13: ["الرعد", "Гром", 43], 14: ["إบراهيم", "Ибрахим", 52], 15: ["الحجر", "Хиджр", 99],
    16: ["النحل", "Пчелы", 128], 17: ["الإسراء", "Ночной перенос", 111], 18: ["الكهف", "Пещера", 110],
    ...
    40: ["غافر", "Прощающий", 85], 41: ["فصلت", "Разъязынены", 54], 42: ["الشورى", "Совет", 53],
    ...
    91: ["الشمس", "Солнце", 15], 92: ["الليل", "Ночь", 21], 93: ["الضحы", "Утро", 11],
    ...
    106: ["قريш", "Курайшиты", 4], 107: ["الماعون", "Подаяние", 7], 108: ["الكوثر", "Обильное", 3],
...
# Изменили роут с '/' на '/bot-webhook' для POST запросов от Telegram
